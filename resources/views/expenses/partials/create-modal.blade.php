        ...
        <div class="inline-block align-bottom bg-white rounded-[2.5rem] text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full border border-beige-100">
            <div class="bg-white px-8 pt-8 pb-6">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <h3 class="text-2xl font-black text-mint-950 tracking-tight">Log New Expense</h3>
                        <p class="text-[10px] font-black text-beige-400 uppercase tracking-widest mt-1">Record financial outflow</p>
                    </div>
                ...
                <form method="POST" action="{{ route('expenses.store') }}">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="description" value="{{ old('description') }}" required placeholder="e.g., Office Supplies, Rent, Utilities"
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="3" placeholder="Optional details for audit trail..."
